...
public class UsuarioService {
    ...
    //Atualizar pessoa completamente
    ...
    public UsuarioDTO atualizar (UsuarioDTO user, Long id){
        ...
        // código feito pelo fernando, altas chances de ter que alterar, mas acho que nem vai precisarkkkkkkkk
        String telefone = user.getTelefone().replaceAll("[\\s\\-()]", "");
        if(telefone.length() == 11){
            if (!telefone.equals(usuario.getTelefone())) {
